        ...
        <div>
            <footer className='footer'>
                <div className='footer__layout'>
                    ...
                    <div className='footer__layout__links'>
                        <ul className='footer__layout__links__list'>
                            <li className='footer__header'>Features</li>
                            <li className='footer__layout__links__list__item'>Link Shortening</li>
                            <li className='footer__layout__links__list__item'>Branded Links</li>
                            <li className='footer__layout__links__list__item'>Analytics</li>
                        </ul>
                        <ul className='footer__layout__links__list'>
                            <li className='footer__header'>Resources</li>
                            <li className='footer__layout__links__list__item'>Blog</li>
                            <li className='footer__layout__links__list__item'>Developers</li>
                            <li className='footer__layout__links__list__item'>Support</li>
                        </ul>
                        <ul className='footer__layout__links__list'>
                            <li
                            className='footer__header'>Company</li>
                            <li className='footer__layout__links__list__item'>About</li>
                            <li className='footer__layout__links__list__item'>Our Team</li>
                            <li className='footer__layout__links__list__item'>Careers</li>
                            <li className='footer__layout__links__list__item'>Contact</li>
                        </ul>
                    </div>
